...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V3.Client.AppsExperimentalEndpoint.StartingApp()" Response
    ...
    public partial class StartingAppResponse : CloudFoundry.CloudController.V3.Client.Data.Base.AbstractStartingAppResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V3.Client.AppsExperimentalEndpoint.StartingApp()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/apps__experimental_/starting_an_app.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractStartingAppResponse
    {
