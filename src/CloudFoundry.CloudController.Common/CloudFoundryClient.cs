namespace CloudFoundry.CloudController.Common
{
    ...
    public abstract class CloudFoundryClient
    {
        ...
        protected CloudFoundryClient(Uri cloudTarget, CancellationToken cancellationToken, Uri httpProxy, bool skipCertificateValidation)
            : this(cloudTarget, cancellationToken, httpProxy, skipCertificateValidation, false)
        {
        }
        ...
        protected CloudFoundryClient(Uri cloudTarget, CancellationToken cancellationToken, Uri httpProxy, bool skipCertificateValidation, bool useStrictStatusCodeChecking)
            : this(cloudTarget, cancellationToken, httpProxy, skipCertificateValidation, useStrictStatusCodeChecking, null)
        {
        }
        ...
        protected CloudFoundryClient(Uri cloudTarget, CancellationToken cancellationToken, Uri httpProxy, bool skipCertificateValidation, bool useStrictStatusCodeChecking, Uri authorizationUrl)
        {
