  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_keys_url"": ""/v2/service_instances/e982d409-a780-4897-92eb-543156b6ecdf/service_keys""
            ...
            Assert.AreEqual("e982d409-a780-4897-92eb-543156b6ecdf", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_instances/e982d409-a780-4897-92eb-543156b6ecdf", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2015-07-29T12:47:23Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-1599", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("dc6770ef-da37-47fc-b687-3a4115e164ba", TestUtil.ToTestableString(page[0].ServicePlanGuid), true);
            Assert.AreEqual("ab76bba4-196f-48c7-976b-6441e6b3c88a", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            ...
            Assert.AreEqual("/v2/spaces/ab76bba4-196f-48c7-976b-6441e6b3c88a", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/service_plans/dc6770ef-da37-47fc-b687-3a4115e164ba", TestUtil.ToTestableString(page[0].ServicePlanUrl), true);
            Assert.AreEqual("/v2/service_instances/e982d409-a780-4897-92eb-543156b6ecdf/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/service_instances/e982d409-a780-4897-92eb-543156b6ecdf/service_keys", TestUtil.ToTestableString(page[0].ServiceKeysUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instances_url"": ""/v2/service_plans/26117526-981b-40e3-8640-048b579d31d6/service_instances""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("26117526-981b-40e3-8640-048b579d31d6", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_plans/26117526-981b-40e3-8640-048b579d31d6", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2015-07-29T12:47:23Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-1604", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("false", TestUtil.ToTestableString(page[0].Free), true);
            Assert.AreEqual("desc-110", TestUtil.ToTestableString(page[0].Description), true);
            Assert.AreEqual("4d5d0106-7729-4128-a05d-a042d408ad68", TestUtil.ToTestableString(page[0].ServiceGuid), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].Extra), true);
            Assert.AreEqual("2ceda77f-83a6-46c2-8554-1d53ce0ed9bf", TestUtil.ToTestableString(page[0].UniqueId), true);
            ...
            Assert.AreEqual("/v2/services/4d5d0106-7729-4128-a05d-a042d408ad68", TestUtil.ToTestableString(page[0].ServiceUrl), true);
            Assert.AreEqual("/v2/service_plans/26117526-981b-40e3-8640-048b579d31d6/service_instances", TestUtil.ToTestableString(page[0].ServiceInstancesUrl), true);
        }
    }
}
