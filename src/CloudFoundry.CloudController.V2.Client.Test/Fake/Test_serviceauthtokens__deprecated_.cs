    ...
    },
    {
      ...
      ""entity"": {
        ...
        ""provider"": ""provider-16""
                ...
                Assert.AreEqual("5ce361d4-f453-4266-a076-109509adfa84", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_auth_tokens/5ce361d4-f453-4266-a076-109509adfa84", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("fc8e6c0f-e449-4b47-9133-3750ea7d2df1", TestUtil.ToTestableString(obj[1].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_auth_tokens/fc8e6c0f-e449-4b47-9133-3750ea7d2df1", TestUtil.ToTestableString(obj[1].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:30Z", TestUtil.ToTestableString(obj[1].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[1].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("label-81", TestUtil.ToTestableString(obj[1].Label), true);
                Assert.AreEqual("provider-15", TestUtil.ToTestableString(obj[1].Provider), true);
                Assert.AreEqual("c7b9e4e1-d236-4007-adae-38883abf2da7", TestUtil.ToTestableString(obj[2].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_auth_tokens/c7b9e4e1-d236-4007-adae-38883abf2da7", TestUtil.ToTestableString(obj[2].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:30Z", TestUtil.ToTestableString(obj[2].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[2].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("label-82", TestUtil.ToTestableString(obj[2].Label), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""provider"": ""provider-7""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("cb91b47a-7d52-4701-b532-51751d7c98ec", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_auth_tokens/cb91b47a-7d52-4701-b532-51751d7c98ec", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:30Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""provider"": ""Face-Offer""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("4bf3b7db-e132-4edd-a95f-4d48cb359d14", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_auth_tokens/4bf3b7db-e132-4edd-a95f-4d48cb359d14", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:30Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("label-70", TestUtil.ToTestableString(obj[0].Label), true);
