    ...
    },
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/apps/f448ef1e-5c1f-4372-a9ef-a3e651b80e00/routes""
                ...
                Assert.AreEqual("302a3f1c-7d03-4b85-a9f1-a01af17d0c35", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/302a3f1c-7d03-4b85-a9f1-a01af17d0c35", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-1824", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].Production), true);
                Assert.AreEqual("ff584ff4-aad9-4a93-b6a6-aa3e57dbaf4e", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("00a55c63-b816-4c02-bf7f-43d2c0cdc0f2", TestUtil.ToTestableString(obj[0].StackGuid), true);
                ...
                Assert.AreEqual("142fe539-e94a-438b-aab1-970bfd39f161", TestUtil.ToTestableString(obj[0].Version), true);
                ...
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[0].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/ff584ff4-aad9-4a93-b6a6-aa3e57dbaf4e", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/00a55c63-b816-4c02-bf7f-43d2c0cdc0f2", TestUtil.ToTestableString(obj[0].StackUrl), true);
                Assert.AreEqual("/v2/apps/302a3f1c-7d03-4b85-a9f1-a01af17d0c35/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/apps/302a3f1c-7d03-4b85-a9f1-a01af17d0c35/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/302a3f1c-7d03-4b85-a9f1-a01af17d0c35/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("7257b2ae-a18d-4b85-aab0-9a8eb416fc89", TestUtil.ToTestableString(obj[1].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/7257b2ae-a18d-4b85-aab0-9a8eb416fc89", TestUtil.ToTestableString(obj[1].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[1].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[1].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-1829", TestUtil.ToTestableString(obj[1].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[1].Production), true);
                Assert.AreEqual("b8a6d06a-fc01-45e3-9c13-f5e945c09bba", TestUtil.ToTestableString(obj[1].SpaceGuid), true);
                Assert.AreEqual("211dc9a9-d276-44bc-9b9c-c1bc40663920", TestUtil.ToTestableString(obj[1].StackGuid), true);
                ...
                Assert.AreEqual("b6b07e40-b1ad-4785-9293-25324eae57d9", TestUtil.ToTestableString(obj[1].Version), true);
                ...
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[1].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/b8a6d06a-fc01-45e3-9c13-f5e945c09bba", TestUtil.ToTestableString(obj[1].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/211dc9a9-d276-44bc-9b9c-c1bc40663920", TestUtil.ToTestableString(obj[1].StackUrl), true);
                Assert.AreEqual("/v2/apps/7257b2ae-a18d-4b85-aab0-9a8eb416fc89/events", TestUtil.ToTestableString(obj[1].EventsUrl), true);
                Assert.AreEqual("/v2/apps/7257b2ae-a18d-4b85-aab0-9a8eb416fc89/service_bindings", TestUtil.ToTestableString(obj[1].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/7257b2ae-a18d-4b85-aab0-9a8eb416fc89/routes", TestUtil.ToTestableString(obj[1].RoutesUrl), true);
                Assert.AreEqual("f448ef1e-5c1f-4372-a9ef-a3e651b80e00", TestUtil.ToTestableString(obj[2].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/f448ef1e-5c1f-4372-a9ef-a3e651b80e00", TestUtil.ToTestableString(obj[2].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[2].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[2].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-1819", TestUtil.ToTestableString(obj[2].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[2].Production), true);
                Assert.AreEqual("58356ec7-4d31-45e0-9c8c-c15ffb293ba1", TestUtil.ToTestableString(obj[2].SpaceGuid), true);
                Assert.AreEqual("b7f7829c-40a1-4d11-b0f4-9d590cde8a72", TestUtil.ToTestableString(obj[2].StackGuid), true);
                ...
                Assert.AreEqual("7e710186-9fdc-4f4b-a402-9f78609d3748", TestUtil.ToTestableString(obj[2].Version), true);
                ...
                Assert.AreEqual("2015-07-29T12:47:26Z", TestUtil.ToTestableString(obj[2].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/58356ec7-4d31-45e0-9c8c-c15ffb293ba1", TestUtil.ToTestableString(obj[2].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/b7f7829c-40a1-4d11-b0f4-9d590cde8a72", TestUtil.ToTestableString(obj[2].StackUrl), true);
                Assert.AreEqual("/v2/apps/f448ef1e-5c1f-4372-a9ef-a3e651b80e00/events", TestUtil.ToTestableString(obj[2].EventsUrl), true);
                Assert.AreEqual("/v2/apps/f448ef1e-5c1f-4372-a9ef-a3e651b80e00/service_bindings", TestUtil.ToTestableString(obj[2].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/f448ef1e-5c1f-4372-a9ef-a3e651b80e00/routes", TestUtil.ToTestableString(obj[2].RoutesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""apps_url"": ""/v2/routes/75a58db5-ac06-4e25-9570-fc398e68d6ba/apps""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("75a58db5-ac06-4e25-9570-fc398e68d6ba", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/routes/75a58db5-ac06-4e25-9570-fc398e68d6ba", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("bcc5bcae-16c1-4684-bcfa-cf726f8b4888", TestUtil.ToTestableString(obj[0].DomainGuid), true);
                Assert.AreEqual("9b92939a-404d-465e-8479-77ba589167c7", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Path), true);
                Assert.AreEqual("/v2/domains/bcc5bcae-16c1-4684-bcfa-cf726f8b4888", TestUtil.ToTestableString(obj[0].DomainUrl), true);
                Assert.AreEqual("/v2/spaces/9b92939a-404d-465e-8479-77ba589167c7", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/routes/75a58db5-ac06-4e25-9570-fc398e68d6ba/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/fce73fd6-021d-4208-9b4f-7051d8ed4a1b""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("8893a0a2-6ad1-4a63-a57b-8fa897ed2b4f", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_bindings/8893a0a2-6ad1-4a63-a57b-8fa897ed2b4f", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:28Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("616f95bd-02e0-487d-b80f-6fee909dad50", TestUtil.ToTestableString(obj[0].AppGuid), true);
                Assert.AreEqual("fce73fd6-021d-4208-9b4f-7051d8ed4a1b", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                ...
                Assert.AreEqual("/v2/apps/616f95bd-02e0-487d-b80f-6fee909dad50", TestUtil.ToTestableString(obj[0].AppUrl), true);
                Assert.AreEqual("/v2/service_instances/fce73fd6-021d-4208-9b4f-7051d8ed4a1b", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
