  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""apps_url"": ""/v2/routes/c9aae653-deb5-4046-afcd-347937074b4c/apps""
                ...
                Assert.AreEqual("c9aae653-deb5-4046-afcd-347937074b4c", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/routes/c9aae653-deb5-4046-afcd-347937074b4c", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:52Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("host-20", TestUtil.ToTestableString(obj[0].Host), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Path), true);
                Assert.AreEqual("82639a0c-5cd2-4636-9767-26c77f8876ee", TestUtil.ToTestableString(obj[0].DomainGuid), true);
                Assert.AreEqual("897fb1f2-3f09-447d-8aa4-ea10058b2925", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("/v2/domains/82639a0c-5cd2-4636-9767-26c77f8876ee", TestUtil.ToTestableString(obj[0].DomainUrl), true);
                Assert.AreEqual("/v2/spaces/897fb1f2-3f09-447d-8aa4-ea10058b2925", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/routes/c9aae653-deb5-4046-afcd-347937074b4c/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/d4f69c18-4b63-462c-84c6-b7fb9754be29""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("8878122d-71d1-4764-9993-f3b35dc5991e", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_bindings/8878122d-71d1-4764-9993-f3b35dc5991e", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:52Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("53f8e1d2-ac6d-49c9-9a19-a14ae533d8ba", TestUtil.ToTestableString(obj[0].AppGuid), true);
                Assert.AreEqual("d4f69c18-4b63-462c-84c6-b7fb9754be29", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                ...
                Assert.AreEqual("/v2/apps/53f8e1d2-ac6d-49c9-9a19-a14ae533d8ba", TestUtil.ToTestableString(obj[0].AppUrl), true);
                Assert.AreEqual("/v2/service_instances/d4f69c18-4b63-462c-84c6-b7fb9754be29", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
    ...
    },
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/apps/cfdb9ede-0455-46bf-ae97-7427097e8f0e/routes""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("3ad291bc-0fad-4a92-8382-97f2bd204976", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/3ad291bc-0fad-4a92-8382-97f2bd204976", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-2136", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].Production), true);
                Assert.AreEqual("1fbe0f5d-9f3f-4ad0-bb9c-1174b16f37c2", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("8eb03cbf-d4c4-425a-ad18-21a29d70579b", TestUtil.ToTestableString(obj[0].StackGuid), true);
                ...
                Assert.AreEqual("698dd2ba-6f80-4a5b-991a-015cd0fbe42c", TestUtil.ToTestableString(obj[0].Version), true);
                ...
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[0].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/1fbe0f5d-9f3f-4ad0-bb9c-1174b16f37c2", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/8eb03cbf-d4c4-425a-ad18-21a29d70579b", TestUtil.ToTestableString(obj[0].StackUrl), true);
                Assert.AreEqual("/v2/apps/3ad291bc-0fad-4a92-8382-97f2bd204976/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/apps/3ad291bc-0fad-4a92-8382-97f2bd204976/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/3ad291bc-0fad-4a92-8382-97f2bd204976/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("8e039849-975d-4f9a-981e-b458ad8bba33", TestUtil.ToTestableString(obj[1].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/8e039849-975d-4f9a-981e-b458ad8bba33", TestUtil.ToTestableString(obj[1].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[1].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[1].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-2126", TestUtil.ToTestableString(obj[1].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[1].Production), true);
                Assert.AreEqual("e57c13ba-0058-413f-a8a5-36160e1fabdc", TestUtil.ToTestableString(obj[1].SpaceGuid), true);
                Assert.AreEqual("b16767c1-0e04-43e0-8df1-4e54e5c4d737", TestUtil.ToTestableString(obj[1].StackGuid), true);
                ...
                Assert.AreEqual("9aae3968-ba8b-4c81-a98b-3710e5955fc1", TestUtil.ToTestableString(obj[1].Version), true);
                ...
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[1].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/e57c13ba-0058-413f-a8a5-36160e1fabdc", TestUtil.ToTestableString(obj[1].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/b16767c1-0e04-43e0-8df1-4e54e5c4d737", TestUtil.ToTestableString(obj[1].StackUrl), true);
                Assert.AreEqual("/v2/apps/8e039849-975d-4f9a-981e-b458ad8bba33/events", TestUtil.ToTestableString(obj[1].EventsUrl), true);
                Assert.AreEqual("/v2/apps/8e039849-975d-4f9a-981e-b458ad8bba33/service_bindings", TestUtil.ToTestableString(obj[1].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/8e039849-975d-4f9a-981e-b458ad8bba33/routes", TestUtil.ToTestableString(obj[1].RoutesUrl), true);
                Assert.AreEqual("cfdb9ede-0455-46bf-ae97-7427097e8f0e", TestUtil.ToTestableString(obj[2].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/cfdb9ede-0455-46bf-ae97-7427097e8f0e", TestUtil.ToTestableString(obj[2].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[2].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[2].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-2131", TestUtil.ToTestableString(obj[2].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[2].Production), true);
                Assert.AreEqual("b7c5de84-a538-4abf-ae66-0fa90aeb79c0", TestUtil.ToTestableString(obj[2].SpaceGuid), true);
                Assert.AreEqual("f5008f8c-8456-4728-a378-dc288d5ddc73", TestUtil.ToTestableString(obj[2].StackGuid), true);
                ...
                Assert.AreEqual("ea8c90dd-3996-4f09-8d7e-9856e171c89c", TestUtil.ToTestableString(obj[2].Version), true);
                ...
                Assert.AreEqual("2016-02-05T12:14:53Z", TestUtil.ToTestableString(obj[2].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/b7c5de84-a538-4abf-ae66-0fa90aeb79c0", TestUtil.ToTestableString(obj[2].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/f5008f8c-8456-4728-a378-dc288d5ddc73", TestUtil.ToTestableString(obj[2].StackUrl), true);
                Assert.AreEqual("/v2/apps/cfdb9ede-0455-46bf-ae97-7427097e8f0e/events", TestUtil.ToTestableString(obj[2].EventsUrl), true);
                Assert.AreEqual("/v2/apps/cfdb9ede-0455-46bf-ae97-7427097e8f0e/service_bindings", TestUtil.ToTestableString(obj[2].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/cfdb9ede-0455-46bf-ae97-7427097e8f0e/routes", TestUtil.ToTestableString(obj[2].RoutesUrl), true);
