  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_plans_url"": ""/v2/services/fc4856d5-5bd7-4ed9-b7b2-8571355baf3d/service_plans""
                ...
                Assert.AreEqual("fc4856d5-5bd7-4ed9-b7b2-8571355baf3d", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/services/fc4856d5-5bd7-4ed9-b7b2-8571355baf3d", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("desc-130", TestUtil.ToTestableString(obj[0].Description), true);
                ...
                Assert.AreEqual("fa0d83fb-6a15-49eb-8737-2da6a0bd9638", TestUtil.ToTestableString(obj[0].UniqueId), true);
                ...
                Assert.AreEqual("149f86f4-be88-4491-b974-46c65c232c85", TestUtil.ToTestableString(obj[0].ServiceBrokerGuid), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].PlanUpdateable), true);
                Assert.AreEqual("/v2/services/fc4856d5-5bd7-4ed9-b7b2-8571355baf3d/service_plans", TestUtil.ToTestableString(obj[0].ServicePlansUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instances_url"": ""/v2/service_plans/542249db-6dbe-4717-b793-97b4cd8e5608/service_instances""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("542249db-6dbe-4717-b793-97b4cd8e5608", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_plans/542249db-6dbe-4717-b793-97b4cd8e5608", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:25Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                ...
                Assert.AreEqual("desc-129", TestUtil.ToTestableString(obj[0].Description), true);
                Assert.AreEqual("874d2088-cc2b-4b1c-9ef8-053222f532eb", TestUtil.ToTestableString(obj[0].ServiceGuid), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Extra), true);
                Assert.AreEqual("46d6ac85-3c41-4c6a-ac1a-436f67238b57", TestUtil.ToTestableString(obj[0].UniqueId), true);
                Assert.AreEqual("true", TestUtil.ToTestableString(obj[0].Public), true);
                Assert.AreEqual("true", TestUtil.ToTestableString(obj[0].Active), true);
                Assert.AreEqual("/v2/services/874d2088-cc2b-4b1c-9ef8-053222f532eb", TestUtil.ToTestableString(obj[0].ServiceUrl), true);
                Assert.AreEqual("/v2/service_plans/542249db-6dbe-4717-b793-97b4cd8e5608/service_instances", TestUtil.ToTestableString(obj[0].ServiceInstancesUrl), true);
