  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""security_groups_url"": ""/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/security_groups""
                ...
                Assert.AreEqual("20c6f451-b6d0-4186-8c30-f7538f6c5a5a", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:49Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2016-02-05T12:14:49Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-1791", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("bf7cc7be-c77d-45c9-befa-d8cd7371dedd", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
                Assert.AreEqual("465adf78-abb3-4f01-8ef7-0d08b4674b4b", TestUtil.ToTestableString(obj[0].SpaceQuotaDefinitionGuid), true);
                Assert.AreEqual("true", TestUtil.ToTestableString(obj[0].AllowSsh), true);
                Assert.AreEqual("/v2/organizations/bf7cc7be-c77d-45c9-befa-d8cd7371dedd", TestUtil.ToTestableString(obj[0].OrganizationUrl), true);
                Assert.AreEqual("/v2/space_quota_definitions/465adf78-abb3-4f01-8ef7-0d08b4674b4b", TestUtil.ToTestableString(obj[0].SpaceQuotaDefinitionUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/developers", TestUtil.ToTestableString(obj[0].DevelopersUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/managers", TestUtil.ToTestableString(obj[0].ManagersUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/auditors", TestUtil.ToTestableString(obj[0].AuditorsUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/domains", TestUtil.ToTestableString(obj[0].DomainsUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/service_instances", TestUtil.ToTestableString(obj[0].ServiceInstancesUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/app_events", TestUtil.ToTestableString(obj[0].AppEventsUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/spaces/20c6f451-b6d0-4186-8c30-f7538f6c5a5a/security_groups", TestUtil.ToTestableString(obj[0].SecurityGroupsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""spaces_url"": ""/v2/space_quota_definitions/c1939d0f-5d1e-46b4-b65c-1eed260164b5/spaces""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("c1939d0f-5d1e-46b4-b65c-1eed260164b5", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/space_quota_definitions/c1939d0f-5d1e-46b4-b65c-1eed260164b5", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:49Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-1798", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("8e517d1f-4495-433d-9d72-e995d582de53", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
                ...
                Assert.AreEqual("/v2/organizations/8e517d1f-4495-433d-9d72-e995d582de53", TestUtil.ToTestableString(obj[0].OrganizationUrl), true);
                Assert.AreEqual("/v2/space_quota_definitions/c1939d0f-5d1e-46b4-b65c-1eed260164b5/spaces", TestUtil.ToTestableString(obj[0].SpacesUrl), true);
