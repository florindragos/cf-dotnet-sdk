  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""security_groups_url"": ""/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/security_groups""
                ...
                Assert.AreEqual("42b65f15-c8f5-4e5a-b46b-bb4bef3d703d", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:17Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-301", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("ed99d764-b187-4b39-9723-f76894ddba1f", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
                ...
                Assert.AreEqual("/v2/organizations/ed99d764-b187-4b39-9723-f76894ddba1f", TestUtil.ToTestableString(obj[0].OrganizationUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/developers", TestUtil.ToTestableString(obj[0].DevelopersUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/managers", TestUtil.ToTestableString(obj[0].ManagersUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/auditors", TestUtil.ToTestableString(obj[0].AuditorsUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/domains", TestUtil.ToTestableString(obj[0].DomainsUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/service_instances", TestUtil.ToTestableString(obj[0].ServiceInstancesUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/app_events", TestUtil.ToTestableString(obj[0].AppEventsUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/spaces/42b65f15-c8f5-4e5a-b46b-bb4bef3d703d/security_groups", TestUtil.ToTestableString(obj[0].SecurityGroupsUrl), true);
    ...
    },
    {
      ...
      ""entity"": {
        ""name"": ""domain-13.example.com""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("9f9550d4-29bd-409f-87e6-7632c19b1c30", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/domains/9f9550d4-29bd-409f-87e6-7632c19b1c30", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("f851df47-7098-4b04-8df8-3858f39fd8da", TestUtil.ToTestableString(obj[1].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/domains/f851df47-7098-4b04-8df8-3858f39fd8da", TestUtil.ToTestableString(obj[1].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("6d9f988f-1ba6-438b-87c9-18e7556da951", TestUtil.ToTestableString(obj[2].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/domains/6d9f988f-1ba6-438b-87c9-18e7556da951", TestUtil.ToTestableString(obj[2].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("f6feee44-09ed-43c7-a8bb-30ba87eeb878", TestUtil.ToTestableString(obj[2].OwningOrganizationGuid), true);
                Assert.AreEqual("/v2/organizations/f6feee44-09ed-43c7-a8bb-30ba87eeb878", TestUtil.ToTestableString(obj[2].OwningOrganizationUrl), true);
                Assert.AreEqual("/v2/domains/6d9f988f-1ba6-438b-87c9-18e7556da951/spaces", TestUtil.ToTestableString(obj[2].SpacesUrl), true);
                Assert.AreEqual("75bb8641-a1f9-45ce-838d-12a7b30b3c21", TestUtil.ToTestableString(obj[3].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/domains/75bb8641-a1f9-45ce-838d-12a7b30b3c21", TestUtil.ToTestableString(obj[3].EntityMetadata.Url), true);
                Assert.AreEqual("2015-07-29T12:47:17Z", TestUtil.ToTestableString(obj[3].EntityMetadata.CreatedAt), true);
