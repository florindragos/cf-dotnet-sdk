  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""spaces_url"": ""/v2/security_groups/372961a7-1616-403f-a3e7-8c28d5e28624/spaces""
                ...
                Assert.AreEqual("372961a7-1616-403f-a3e7-8c28d5e28624", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/security_groups/372961a7-1616-403f-a3e7-8c28d5e28624", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-316", TestUtil.ToTestableString(obj[0].Name), true);
                ...
                Assert.AreEqual("/v2/security_groups/372961a7-1616-403f-a3e7-8c28d5e28624/spaces", TestUtil.ToTestableString(obj[0].SpacesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""audited_spaces_url"": ""/v2/users/uaa-id-111/audited_spaces""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("uaa-id-111", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/users/uaa-id-111", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("/v2/users/uaa-id-111/spaces", TestUtil.ToTestableString(obj[0].SpacesUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-111/organizations", TestUtil.ToTestableString(obj[0].OrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-111/managed_organizations", TestUtil.ToTestableString(obj[0].ManagedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-111/billing_managed_organizations", TestUtil.ToTestableString(obj[0].BillingManagedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-111/audited_organizations", TestUtil.ToTestableString(obj[0].AuditedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-111/managed_spaces", TestUtil.ToTestableString(obj[0].ManagedSpacesUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-111/audited_spaces", TestUtil.ToTestableString(obj[0].AuditedSpacesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""apps_url"": ""/v2/routes/106e06db-a266-4aad-afa0-9c836f9b118c/apps""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("106e06db-a266-4aad-afa0-9c836f9b118c", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/routes/106e06db-a266-4aad-afa0-9c836f9b118c", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("host-15", TestUtil.ToTestableString(obj[0].Host), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Path), true);
                Assert.AreEqual("2d3a6fb2-7b84-4f48-bb4a-034d61ec4917", TestUtil.ToTestableString(obj[0].DomainGuid), true);
                Assert.AreEqual("07d8c2bc-6f51-45f4-b94d-15e23f9f837a", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("/v2/domains/2d3a6fb2-7b84-4f48-bb4a-034d61ec4917", TestUtil.ToTestableString(obj[0].DomainUrl), true);
                Assert.AreEqual("/v2/spaces/07d8c2bc-6f51-45f4-b94d-15e23f9f837a", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/routes/106e06db-a266-4aad-afa0-9c836f9b118c/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_keys_url"": ""/v2/service_instances/6e42d94a-91ed-4a4a-a1b8-39d0b891cf72/service_keys""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("6e42d94a-91ed-4a4a-a1b8-39d0b891cf72", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_instances/6e42d94a-91ed-4a4a-a1b8-39d0b891cf72", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-278", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("71a79f53-0534-462d-866b-7e35c504d208", TestUtil.ToTestableString(obj[0].ServicePlanGuid), true);
                Assert.AreEqual("30df1341-5c79-4689-a490-b3dc0b022eb8", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                ...
                Assert.AreEqual("/v2/spaces/30df1341-5c79-4689-a490-b3dc0b022eb8", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/service_plans/71a79f53-0534-462d-866b-7e35c504d208", TestUtil.ToTestableString(obj[0].ServicePlanUrl), true);
                Assert.AreEqual("/v2/service_instances/6e42d94a-91ed-4a4a-a1b8-39d0b891cf72/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/service_instances/6e42d94a-91ed-4a4a-a1b8-39d0b891cf72/service_keys", TestUtil.ToTestableString(obj[0].ServiceKeysUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""audited_spaces_url"": ""/v2/users/uaa-id-116/audited_spaces""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("uaa-id-116", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/users/uaa-id-116", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:40Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                ...
                Assert.AreEqual("/v2/users/uaa-id-116/spaces", TestUtil.ToTestableString(obj[0].SpacesUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-116/organizations", TestUtil.ToTestableString(obj[0].OrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-116/managed_organizations", TestUtil.ToTestableString(obj[0].ManagedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-116/billing_managed_organizations", TestUtil.ToTestableString(obj[0].BillingManagedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-116/audited_organizations", TestUtil.ToTestableString(obj[0].AuditedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-116/managed_spaces", TestUtil.ToTestableString(obj[0].ManagedSpacesUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-116/audited_spaces", TestUtil.ToTestableString(obj[0].AuditedSpacesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""organization_guid"": ""027d05cc-d95d-4366-8331-90460c741690""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("6c8e7be7-8f0e-471d-ade5-f84466d967b9", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/events/6c8e7be7-8f0e-471d-ade5-f84466d967b9", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("audit.space.update", TestUtil.ToTestableString(obj[0].Type), true);
                Assert.AreEqual("uaa-id-107", TestUtil.ToTestableString(obj[0].Actor), true);
                ...
                Assert.AreEqual("ef1f55cb-0939-402b-a240-cb79007d183b", TestUtil.ToTestableString(obj[0].Actee), true);
                ...
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].Timestamp), true);
                Assert.AreEqual("ef1f55cb-0939-402b-a240-cb79007d183b", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("027d05cc-d95d-4366-8331-90460c741690", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""security_groups_url"": ""/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/security_groups""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("2606a317-7eb0-4008-a19f-44e0223ddaeb", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-264", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("f224947b-8bcf-497a-b475-f2fccf1dfd8c", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
                ...
                Assert.AreEqual("/v2/organizations/f224947b-8bcf-497a-b475-f2fccf1dfd8c", TestUtil.ToTestableString(obj[0].OrganizationUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/developers", TestUtil.ToTestableString(obj[0].DevelopersUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/managers", TestUtil.ToTestableString(obj[0].ManagersUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/auditors", TestUtil.ToTestableString(obj[0].AuditorsUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/domains", TestUtil.ToTestableString(obj[0].DomainsUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/service_instances", TestUtil.ToTestableString(obj[0].ServiceInstancesUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/app_events", TestUtil.ToTestableString(obj[0].AppEventsUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/spaces/2606a317-7eb0-4008-a19f-44e0223ddaeb/security_groups", TestUtil.ToTestableString(obj[0].SecurityGroupsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""audited_spaces_url"": ""/v2/users/uaa-id-96/audited_spaces""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("uaa-id-96", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/apps/11ca333c-9881-47e8-b54a-b448534a897b/routes""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("11ca333c-9881-47e8-b54a-b448534a897b", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/11ca333c-9881-47e8-b54a-b448534a897b", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-302", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].Production), true);
                Assert.AreEqual("1950a2fd-ba12-4ee1-99b0-5a7e3b7c2fc1", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("3907cf59-d8ee-4c75-ae0e-1fa02c9f5194", TestUtil.ToTestableString(obj[0].StackGuid), true);
                ...
                Assert.AreEqual("63681fa7-0a0e-4013-94c7-52af84f13609", TestUtil.ToTestableString(obj[0].Version), true);
                ...
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/1950a2fd-ba12-4ee1-99b0-5a7e3b7c2fc1", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/3907cf59-d8ee-4c75-ae0e-1fa02c9f5194", TestUtil.ToTestableString(obj[0].StackUrl), true);
                Assert.AreEqual("/v2/apps/11ca333c-9881-47e8-b54a-b448534a897b/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/apps/11ca333c-9881-47e8-b54a-b448534a897b/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/11ca333c-9881-47e8-b54a-b448534a897b/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""audited_spaces_url"": ""/v2/users/uaa-id-87/audited_spaces""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("uaa-id-87", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/users/uaa-id-87", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].Admin), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].Active), true);
                ...
                Assert.AreEqual("/v2/users/uaa-id-87/spaces", TestUtil.ToTestableString(obj[0].SpacesUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-87/organizations", TestUtil.ToTestableString(obj[0].OrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-87/managed_organizations", TestUtil.ToTestableString(obj[0].ManagedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-87/billing_managed_organizations", TestUtil.ToTestableString(obj[0].BillingManagedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-87/audited_organizations", TestUtil.ToTestableString(obj[0].AuditedOrganizationsUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-87/managed_spaces", TestUtil.ToTestableString(obj[0].ManagedSpacesUrl), true);
                Assert.AreEqual("/v2/users/uaa-id-87/audited_spaces", TestUtil.ToTestableString(obj[0].AuditedSpacesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_plans_url"": ""/v2/services/66e441aa-1df8-416f-a7b6-8c70833c8eda/service_plans""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("66e441aa-1df8-416f-a7b6-8c70833c8eda", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/services/66e441aa-1df8-416f-a7b6-8c70833c8eda", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-05T12:14:39Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("label-3", TestUtil.ToTestableString(obj[0].Label), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Provider), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Url), true);
                Assert.AreEqual("desc-19", TestUtil.ToTestableString(obj[0].Description), true);
                ...
                Assert.AreEqual("29bff6f6-73a1-4950-adaf-36746956c8f5", TestUtil.ToTestableString(obj[0].UniqueId), true);
                ...
                Assert.AreEqual("ee33d3cf-bf73-493c-98c0-367b18798c5c", TestUtil.ToTestableString(obj[0].ServiceBrokerGuid), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].PlanUpdateable), true);
                Assert.AreEqual("/v2/services/66e441aa-1df8-416f-a7b6-8c70833c8eda/service_plans", TestUtil.ToTestableString(obj[0].ServicePlansUrl), true);
