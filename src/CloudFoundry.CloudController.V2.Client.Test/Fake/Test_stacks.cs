    ...
    },
    {
      ...
      ""entity"": {
        ...
        ""description"": ""cider-description""
                ...
                Assert.AreEqual("10b664d3-bc45-4eb9-9290-35d593c46196", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/stacks/10b664d3-bc45-4eb9-9290-35d593c46196", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("36b77737-57fe-49eb-8929-73114350bb74", TestUtil.ToTestableString(obj[1].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/stacks/36b77737-57fe-49eb-8929-73114350bb74", TestUtil.ToTestableString(obj[1].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("2ba5ea80-ed25-4edf-83ae-0b701e7b4d16", TestUtil.ToTestableString(obj[2].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/stacks/2ba5ea80-ed25-4edf-83ae-0b701e7b4d16", TestUtil.ToTestableString(obj[2].EntityMetadata.Url), true);
