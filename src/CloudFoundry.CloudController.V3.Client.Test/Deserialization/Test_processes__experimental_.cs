      ...
      ""_links"": {
        ...
        ""space"": {
          ""href"": ""/v2/spaces/7f22b2c9-1a60-4d83-bc23-6786377137bb""
            ...
            Assert.AreEqual("ca0c0aba-830a-46fe-8d19-08009ce92e7e", TestUtil.ToTestableString(page[0].Guid), true);
            ...
            Assert.AreEqual("2015-07-29T12:47:17Z", TestUtil.ToTestableString(page[0].CreatedAt), true);
            Assert.AreEqual("2015-07-29T12:47:17Z", TestUtil.ToTestableString(page[0].UpdatedAt), true);
            Assert.AreEqual("78256f69-166f-4609-8cad-bd2392a90930", TestUtil.ToTestableString(page[1].Guid), true);
            ...
            Assert.AreEqual("2015-07-29T12:47:17Z", TestUtil.ToTestableString(page[1].CreatedAt), true);
            Assert.AreEqual("2015-07-29T12:47:17Z", TestUtil.ToTestableString(page[1].UpdatedAt), true);
        }
