...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.EventsEndpoint.ListAppSshUnauthorizedEvents()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/events/list_app_ssh_unauthorized_events.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class ListAppSshUnauthorizedEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractListAppSshUnauthorizedEventsResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.EventsEndpoint.ListAppSshUnauthorizedEvents()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/events/list_app_ssh_unauthorized_events.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractListAppSshUnauthorizedEventsResponse : IResponse
    {
        /// <summary>
