...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/domains__deprecated_/creates_a_domain_owned_by_the_given_organization_(deprecated).html"</para>
    /// </summary>
...
{
    /// <summary>
    /// Base abstract data class used for serializing the "CloudFoundry.CloudController.V2.Client.DomainsDeprecatedEndpoint.CreatesDomainOwnedByGivenOrganizationDeprecated()" Request
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/domains__deprecated_/creates_a_domain_owned_by_the_given_organization_(deprecated).html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
