...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/domains__deprecated_/creates_a_shared_domain_(deprecated).html"</para>
    /// </summary>
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.DomainsDeprecatedEndpoint.CreatesSharedDomainDeprecated()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/domains__deprecated_/creates_a_shared_domain_(deprecated).html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
