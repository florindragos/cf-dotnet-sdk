...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.ListAllOrganizationsForUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/users/list_all_organizations_for_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class ListAllOrganizationsForUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractListAllOrganizationsForUserResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.ListAllOrganizationsForUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/users/list_all_organizations_for_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractListAllOrganizationsForUserResponse : IResponse
    {
        /// <summary>
