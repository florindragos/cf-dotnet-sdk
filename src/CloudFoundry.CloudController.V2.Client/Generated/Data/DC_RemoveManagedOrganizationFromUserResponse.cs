...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.RemoveManagedOrganizationFromUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/users/remove_managed_organization_from_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class RemoveManagedOrganizationFromUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractRemoveManagedOrganizationFromUserResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.RemoveManagedOrganizationFromUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/users/remove_managed_organization_from_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractRemoveManagedOrganizationFromUserResponse : IResponse
    {
        /// <summary>
