...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.RemoveManagedSpaceFromUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/users/remove_managed_space_from_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class RemoveManagedSpaceFromUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractRemoveManagedSpaceFromUserResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.RemoveManagedSpaceFromUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/users/remove_managed_space_from_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractRemoveManagedSpaceFromUserResponse : IResponse
    {
        /// <summary>
