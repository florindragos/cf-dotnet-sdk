...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.AssociateSpaceWithUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/users/associate_space_with_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class AssociateSpaceWithUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractAssociateSpaceWithUserResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.AssociateSpaceWithUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/users/associate_space_with_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractAssociateSpaceWithUserResponse : IResponse
    {
        /// <summary>
