...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.RetrievingRolesOfAllUsersInSpace()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/spaces/retrieving_the_roles_of_all_users_in_the_space.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class RetrievingRolesOfAllUsersInSpaceResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractRetrievingRolesOfAllUsersInSpaceResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.RetrievingRolesOfAllUsersInSpace()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/spaces/retrieving_the_roles_of_all_users_in_the_space.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractRetrievingRolesOfAllUsersInSpaceResponse : IResponse
    {
        /// <summary>
        ...
        /// <summary> 
        /// <para>The Space Roles</para>
        /// </summary>
        [JsonProperty("space_roles", NullValueHandling = NullValueHandling.Ignore)]
