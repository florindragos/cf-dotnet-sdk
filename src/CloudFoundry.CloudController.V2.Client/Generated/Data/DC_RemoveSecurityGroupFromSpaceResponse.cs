...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.RemoveSecurityGroupFromSpace()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/spaces/remove_security_group_from_the_space.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class RemoveSecurityGroupFromSpaceResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractRemoveSecurityGroupFromSpaceResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.RemoveSecurityGroupFromSpace()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/spaces/remove_security_group_from_the_space.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractRemoveSecurityGroupFromSpaceResponse : IResponse
    {
        /// <summary>
