...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.ServiceBindingsEndpoint.ListAllServiceBindings()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/service_bindings/list_all_service_bindings.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class ListAllServiceBindingsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractListAllServiceBindingsResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.ServiceBindingsEndpoint.ListAllServiceBindings()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/service_bindings/list_all_service_bindings.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractListAllServiceBindingsResponse : IResponse
    {
        /// <summary>
