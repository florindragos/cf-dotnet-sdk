...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.AssociateBillingManagedOrganizationWithUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/users/associate_billing_managed_organization_with_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class AssociateBillingManagedOrganizationWithUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractAssociateBillingManagedOrganizationWithUserResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.AssociateBillingManagedOrganizationWithUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/users/associate_billing_managed_organization_with_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractAssociateBillingManagedOrganizationWithUserResponse : IResponse
    {
        /// <summary>
