...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/service_instances/migrate_service_instances_from_one_service_plan_to_another_service_plan_(experimental).html"</para>
    /// </summary>
...
{
    /// <summary>
    /// Base abstract data class used for serializing the "CloudFoundry.CloudController.V2.Client.ServiceInstancesEndpoint.MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimental()" Request
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/service_instances/migrate_service_instances_from_one_service_plan_to_another_service_plan_(experimental).html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
