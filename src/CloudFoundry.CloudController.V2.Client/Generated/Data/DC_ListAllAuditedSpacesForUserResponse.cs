...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.ListAllAuditedSpacesForUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/users/list_all_audited_spaces_for_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class ListAllAuditedSpacesForUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractListAllAuditedSpacesForUserResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.UsersEndpoint.ListAllAuditedSpacesForUser()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/users/list_all_audited_spaces_for_the_user.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractListAllAuditedSpacesForUserResponse : IResponse
    {
        /// <summary>
