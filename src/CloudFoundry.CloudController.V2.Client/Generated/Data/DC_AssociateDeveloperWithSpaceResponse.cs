...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.AssociateDeveloperWithSpace()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/spaces/associate_developer_with_the_space.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class AssociateDeveloperWithSpaceResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractAssociateDeveloperWithSpaceResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.AssociateDeveloperWithSpace()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/208/spaces/associate_developer_with_the_space.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractAssociateDeveloperWithSpaceResponse : IResponse
    {
        /// <summary>
