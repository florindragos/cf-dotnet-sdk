...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.EventsEndpoint.ListServiceBrokerDeleteEvents()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/events/list_service_broker_delete_events.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class ListServiceBrokerDeleteEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractListServiceBrokerDeleteEventsResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.EventsEndpoint.ListServiceBrokerDeleteEvents()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/210/events/list_service_broker_delete_events.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractListServiceBrokerDeleteEventsResponse : IResponse
    {
        /// <summary>
